...
<body>
      ...
      <div class="row align-items-center mt-5">
        <div class="col-lg-6 text-lg-start text-center">
          <div class="bennercontent">
            ...
            <button type="button" class="btn button btn-dark mt-3" onclick="window.location.href='book.php'">See Book</button>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-sm-6 col-12 ">
          <div class="card text-center shadow-sm border-0 h-100">
            <div class="card-body hhh">
              ...
              <p>Fiction books contain stories created from the author’s imagination rather than real events.</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-sm-6 col-12">
          <div class="card text-center shadow-sm border-0 h-100">
            <div class="card-body hhh">
              ...
              <p>Education books focus on learning, teaching, and knowledge development.</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-sm-6 col-12">
          <div class="card text-center shadow-sm border-0 h-100">
            <div class="card-body hhh">
              ...
              <p>Novels are long, fictional narratives that explore characters, emotions, and life experiences through storytelling.</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-3 col-sm-6 col-12">
          <div class="card text-center shadow-sm border-0 h-100">
            <div class="card-body hhh">
              ...
              <p>Science & Technology books explain discoveries, inventions, and advancements that shape our modern world.</p>
            </div>
          </div>
        </div>
  ...
  <section class="container-fluid py-5 bg-white">
    <div class="container">
      <h2 class="text-center mb-5 fw-bold">Important Order Information</h2>
      <div class="row justify-content-center">
        <div class="col-lg-8 col-md-10">
          <div class="p-4 shadow-lg text-center bg-light border border-warning-subtle rounded">
            <i class="bi bi-exclamation-triangle-fill text-warning fs-1 mb-3"></i>
            <h5 class="fw-bold">Our Cancellation Policy</h5>
            <p class="text-muted mb-0">
              Please review your cart carefully before proceeding to checkout. To ensure a fast and fair process for both buyers and sellers on our platform, **once an order is placed, it is considered final and cannot be canceled.**
            </p>
          </div>
        </div>
      </div>
